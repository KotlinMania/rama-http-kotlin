...
This file is the quick-reference operating contract for rama-http-kotlin. The longer
...
rama-http-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-http`](https://crates.io/crates/rama-http). Upstream Rust is the behavioral oracle while the
