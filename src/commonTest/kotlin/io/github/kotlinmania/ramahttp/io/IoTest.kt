...
class IoTest {
    ...
    @Test
    fun testWriteHttpRequestGet() = runTest {
    ...
    @Test
    fun testWriteHttpRequestGetWithHeaders() = runTest {
        val req = Request.builder()
            .method(Method.GET)
            .uri("http://example.com")
    ...
    @Test
    fun testWriteHttpRequestPostWithBody() = runTest {
        val req = Request.builder()
            .method(Method.POST)
            .uri("http://example.com")
            .header(HeaderName.CONTENT_TYPE, HeaderValue.fromString("text/plain"))
    ...
    @Test
    fun testWriteResponseOk() = runTest {
    ...
    @Test
    fun testWriteResponseRedirect() = runTest {
        val res = Response.builder()
    ...
    @Test
    fun testWriteResponseWithHeadersAndBody() = runTest {
        val res = Response.builder()
            .status(StatusCode.OK)
            .header(HeaderName.CONTENT_TYPE, HeaderValue.fromString("text/plain"))
            .header(HeaderName.SERVER, HeaderValue.fromString("test/0"))
