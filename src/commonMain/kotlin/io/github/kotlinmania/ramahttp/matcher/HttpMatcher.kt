// port-lint: source rama-http/src/matcher/mod.rs
...
public class HttpMatcher private constructor(
    ...
    private sealed class Kind {
        ...
        class Header(
            val matcher: HeaderMatcher,
        ) : Kind()

        class SubdomainTrie(
            val matcher: SubdomainTrieMatcher,
        ) : Kind()

        class Custom(
            val matcher: io.github.kotlinmania.ramahttp.core.RequestMatcher,
        ) : Kind()
    }
    ...
    public companion object {
        ...
        public fun custom(matcher: Matcher<Request>): HttpMatcher =
            HttpMatcher(
                Kind.Custom(
                    io.github.kotlinmania.ramahttp.core
                        .RequestMatcher { ext, req -> matcher.matches(ext, req) },
                ),
            )
    }
}
