...
public sealed class Body {
    ...
    public open fun isEmpty(): Boolean = when (this) {
        is Empty -> true
    ...
    public open fun intoBytes(): ByteArray = when (this) {
    ...
    public open fun intoString(): String = when (this) {
        is Empty -> ""
    ...
    public class Text(public val text: String) : Body() {
    ...
    public class Stream(public val flow: Flow<ByteArray>) : Body() {
