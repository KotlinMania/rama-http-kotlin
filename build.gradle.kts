...
kotlin {
    ...
    val xcf = XCFramework("RamaHttp")

    macosArm64 {
        binaries.framework { baseName = "RamaHttp"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaHttp"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaHttp"
        flattenPackage = "io.github.kotlinmania.ramahttp"
    }

    android {
        namespace = "io.github.kotlinmania.ramahttp"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-http-kotlin", version.toString())

    pom {
        name.set("rama-http-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - rama http layers, services and other utilities")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-http-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-http-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-http-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-http-kotlin.git")
        }
    }
}

val codeqlKotlinc: Configuration by configurations.creating {
    description = "Kotlin compiler for CodeQL extraction"
...
tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/ramahttp/codeql/_CodeqlEmptySource.kt")
            sentinelFile.parentFile.mkdirs()
            sentinelFile.writeText(
                """
                package io.github.kotlinmania.ramahttp.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaHttpXCFramework",
    "assembleRamaHttpDebugXCFramework",
    "assembleRamaHttpReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseIosFatFrameworkForRamaHttpXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaHttpXCFramework",
    "assembleDebugMacosFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseMacosFatFrameworkForRamaHttpXCFramework",
    "assembleDebugTvosFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseTvosFatFrameworkForRamaHttpXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaHttpXCFramework",
    "assembleDebugWatchosFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaHttpXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaHttpXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaHttpXCFramework",
